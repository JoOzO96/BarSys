...
public class ClienteConverter implements Converter {
	@Override
	public ClienteConverter getAsObject(FacesContext fc, UIComponent uic, String value) {
		if (value != null && value.trim().length() > 0) {
			try {
				EntityManager em = FabricaConexao.getEntityManager();
				ClienteConverter ret = em.find(ClienteConverter.class, Long.parseLong(value));
				em.close();
				return ret;
