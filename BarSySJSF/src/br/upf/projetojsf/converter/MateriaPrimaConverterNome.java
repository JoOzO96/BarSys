...
@FacesConverter(value = "materiaPrimaConverterNome")
public class MateriaPrimaConverterNome implements Converter {
	@Override
	...
	@Override
	 public String getAsString(FacesContext fc, UIComponent uic, Object object) {
		 if(object != null) {
			return String.valueOf(((MateriaPrima) object).getNome());
		 } else
		 	return null;
	}
}